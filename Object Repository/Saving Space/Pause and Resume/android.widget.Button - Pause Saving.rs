...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Pause Saving</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Pause Saving' or . = 'Pause Saving') and @resource-id = 'com.arabbank.neobank:id/pauseResumeBtn']</locator>
