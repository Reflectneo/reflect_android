...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - My Spaces</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'My Spaces' or . = 'My Spaces') and @resource-id = 'com.arabbank.neobank:id/headerText']</locator>
