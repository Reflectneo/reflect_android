...
<MobileElementEntity>
   ...
   <name>android.widget.Button-Plus Icon</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and @resource-id = 'com.arabbank.neobank:id/addSavingSpace' and (@text = '' or . = '')]</locator>
