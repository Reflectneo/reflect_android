...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Saving Space</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Saving Space' or . = 'Saving Space')]</locator>
