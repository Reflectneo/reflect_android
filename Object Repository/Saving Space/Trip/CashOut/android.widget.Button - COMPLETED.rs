...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'COMPLETED' or . = 'COMPLETED') and @resource-id = 'com.arabbank.neobank:id/statusBtn']</locator>
