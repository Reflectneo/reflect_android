...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Jordan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Jordan' or . = 'Jordan') and @resource-id = 'address_country']</locator>
