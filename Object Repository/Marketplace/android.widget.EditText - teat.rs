...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - teat</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'teat' or . = 'teat') and @resource-id = 'shipping_first_name']</locator>
