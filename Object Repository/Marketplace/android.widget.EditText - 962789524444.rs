...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - 962789524444</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '+962789524444' or . = '+962789524444') and @resource-id = 'shipping_phone']</locator>
