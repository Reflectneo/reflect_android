...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Apply promo code</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Apply promo code' or . = 'Apply promo code')]</locator>
