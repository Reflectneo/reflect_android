...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Checkout' or . = 'Checkout') and @resource-id = 'init-checkout']</locator>
