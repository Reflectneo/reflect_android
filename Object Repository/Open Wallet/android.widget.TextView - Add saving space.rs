...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Add saving space</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Add saving space' or . = 'Add saving space') and @resource-id = 'com.arabbank.neobank:id/header']</locator>
