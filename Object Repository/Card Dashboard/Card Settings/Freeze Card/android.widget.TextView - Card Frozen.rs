...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Card Frozen</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Card Frozen' or . = 'Card Frozen')]</locator>
