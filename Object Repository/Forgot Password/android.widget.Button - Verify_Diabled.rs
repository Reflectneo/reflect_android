...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Verify_Diabled</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Verify' or . = 'Verify') and @resource-id = 'com.arabbank.neobank:id/verify']</locator>
