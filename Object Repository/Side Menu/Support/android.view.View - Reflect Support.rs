...
<MobileElementEntity>
   ...
   <name>android.view.View - Reflect Support</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Reflect Support' or . = 'Reflect Support') and @resource-id = 'single-subtitle']</locator>
