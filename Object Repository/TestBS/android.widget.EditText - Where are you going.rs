...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Where are you going</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Where are you going?' or . = 'Where are you going?') and @resource-id = 'com.arabbank.neobank:id/whereToGo']</locator>
