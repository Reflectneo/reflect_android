...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Card Number' or . = 'Card Number') and @resource-id = 'com.arabbank.neobank:id/cardNo']</locator>
