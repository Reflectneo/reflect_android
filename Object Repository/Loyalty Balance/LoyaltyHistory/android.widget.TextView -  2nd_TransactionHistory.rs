...
<MobileElementEntity>
   ...
   <name>android.widget.TextView -  2nd_TransactionHistory</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '+ 5.0 POINTS' or . = '+ 5.0 POINTS') and @resource-id = 'com.arabbank.neobank:id/value']</locator>
