...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - 20 Minutes</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '20 Minutes' or . = '20 Minutes') and @resource-id = 'com.arabbank.neobank:id/expTime']</locator>
