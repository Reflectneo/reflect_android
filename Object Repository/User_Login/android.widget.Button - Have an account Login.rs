...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Have an account Login</name>
   <tag></tag>
   ...
   <webElementProperties>
      ...
      <name>bounds</name>
      <type>Main</type>
      <value>[140,2487][1300,2732]</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Have an account? Login' or . = 'Have an account? Login') and @resource-id = 'com.arabbank.neobank:id/login']</locator>
