...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - What is a wallet</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'What is a wallet?' or . = 'What is a wallet?') and @resource-id = 'com.arabbank.neobank:id/title']</locator>
