...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Start Fresh' or . = 'Start Fresh') and @resource-id = 'com.arabbank.neobank:id/start_fresh_option_title_text_view']</locator>
