...
'Click on Request'
Mobile.tap(findTestObject('Send and Request/android.widget.TextView - JOD 120.0'), 10)

Mobile.takeScreenshot()

'Click on Accept'
Mobile.tap(findTestObject('Send and Request/android.widget.Button - Accept'), 10)
...
Mobile.verifyElementExist(findTestObject('Send and Request/android.widget.TextView - Your transaction was successful'), 
    0)
