...
for (int i = 0; i < 10; i++) {
    if (Mobile.verifyElementExist(findTestObject('Saving Space/Saving Dashboard/android.widget.Button - Add Saving Space') ,30,  FailureHandling.CONTINUE_ON_FAILURE)) {
        break;
    } else {
