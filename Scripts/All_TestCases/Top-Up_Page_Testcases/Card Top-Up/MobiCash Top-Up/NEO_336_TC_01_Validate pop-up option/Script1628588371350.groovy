...
Mobile.verifyElementExist(findTestObject('Top Up/Card Top-up/android.widget.TextView - Are you using Arab Bank debit card'), 
    10)

'Verify Yes Button'
Mobile.verifyElementExist(findTestObject('Top Up/Card Top-up/android.widget.Button - Yes  For Arab Bank debit card'), 10)

'Verify Cancel Button'
Mobile.verifyElementExist(findTestObject('Top Up/Card Top-up/android.widget.Button - No For Arab Bank debit card'), 10)
