...
'Blank Password on Password Fields'
Mobile.setText(findTestObject('User_Login/android.widget.EditText - Password'), '', 0)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('password is required', GlobalVariable.OutputFile)
