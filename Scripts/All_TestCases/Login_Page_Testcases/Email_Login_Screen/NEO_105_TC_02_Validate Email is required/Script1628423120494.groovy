...
'Blank Email on Email Fields'
Mobile.setText(findTestObject('User_Login/android.widget.EditText - Email address'), '', 0)
...
Mobile.verifyElementExist(findTestObject('User_Login/android.widget.TextView - Email and Password are required'), 0)
