...
//def message = Mobile.getText(findTestObject('User_Registration/Registration_Screen/MobileVerificationViaOTP/android.widget.TextView - You have successfully verified the account'), 
//  10)
//Mobile.verifyElementText(findTestObject('User_Registration/Registration_Screen/MobileVerificationViaOTP/android.widget.TextView - You have successfully verified the account'), 'You have successfully verified the account')
//Mobile.verifyEqual(message, 'You have successfully verified the account')
Mobile.takeScreenshot()
