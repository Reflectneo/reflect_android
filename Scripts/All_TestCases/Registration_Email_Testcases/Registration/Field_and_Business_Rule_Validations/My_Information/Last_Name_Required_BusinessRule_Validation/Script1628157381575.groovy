...
//Mobile.tap(findTestObject('User_Registration/Registration_Screen/MyInformation/android.widget.EditText - Last Name'), 2)
Mobile.clearText(findTestObject('User_Registration/Registration_Screen/MyInformation/android.widget.EditText - Last Name'), 
    0)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Please enter your family name', GlobalVariable.OutputFile)
