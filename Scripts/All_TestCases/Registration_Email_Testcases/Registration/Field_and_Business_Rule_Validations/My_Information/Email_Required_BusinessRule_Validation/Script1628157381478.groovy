...
Mobile.clearText(findTestObject('User_Registration/Registration_Screen/MyInformation/android.widget.EditText - Email'), 
    0)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Please enter your email', GlobalVariable.OutputFile)
