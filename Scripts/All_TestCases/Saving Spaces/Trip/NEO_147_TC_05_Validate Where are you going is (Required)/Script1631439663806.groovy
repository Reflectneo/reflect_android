...
Mobile.clearText(findTestObject('Saving Space/Trip/Setup your saving space/android.widget.EditText - Where are you going'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Where are you going is required', GlobalVariable.OutputFile)
